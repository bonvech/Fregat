// 2007.01
// trigger software
// 2011.02.01 - changes to use new modification
...
//////////////////////////////////////
 ...
 unsigned char CheckReg(unsigned short int Addr, unsigned char Reg)
 {
    ...
    if(dout) fprintf(dout, "\nCheckReg: Ad=%x Da=%i Reg=%i bit = %i\n", Addr, Da, Reg, bit);
...
/* unsigned char set_threshould(unsigned short int Thre)
 {
     ...
     if(dout) fprintf(dout, "\nSet_threshold: trigger TGTHR is set = %i\n", Thre);
     return 0;
 }*/
 // ///////////////////////////////////////////////////////
 unsigned char set_local_threshould(unsigned short int Thre)
 {
     ...
     SetAddr(TGLTHR);
     WriteData(Thre);
     printf("\nSset_threshold: trigger TGLTHR is set= %i\n", Thre);
     if(dout) fprintf(dout, "\nSet_threshold: trigger TGLTHR is set = %i\n", Thre);
     return 0;
 }
 // ///////////////////////////////////////////////////////
 unsigned char set_global_threshould(unsigned short int Thre)
 {
     ...
     SetAddr(TGGTHR);
     WriteData(Thre);
     printf("\nSset_threshold: trigger TGGTHR is set= %i\n", Thre);
     if(dout) fprintf(dout, "\nSet_threshold: trigger TGGTHR is set = %i\n", Thre);
     return 0;
 }
 ...
 // ///////////////////////////////////////////////////////
 // add or exclude channel from TriggerOnOff
 // ChanNum - from 0
 ...
 // ///////////////////////////////////////////////////////
 // fill TriggerOnOff[7] (array to write to EVENTVB) according to trigger[112]
 // /////////////////////
 int fill_TriggerOnOff(unsigned short *trigger)
 {
    ...
    printf("TriggerOnOff:\n");
    if(dout) fprintf(dout, "TriggerOnOff:\n");
    for(j = 0; j < 7; j++)
    {
...
///////////////////////////////////////////////
 ...
 // return: 0 - is empty, 1 - is full
 {
     //printf("NotEmpty:");
     //if(dout) fprintf(dout, "NotEmpty:");
...
/*
unsigned short int ReadData(unsigned short int Addr)
{
    unsigned short int Data;
    outw(Addr,ADDR);
    Data = inw(DATA);
...
int WriteData(unsigned short int Addr, unsigned short int Data)
{
